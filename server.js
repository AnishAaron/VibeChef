...
var HISTORY_FILE = path.join(__dirname, "src", "data", "history.json");
...
app.post("/api/generate-plan", async (req, res) => {
  ...
  const pantryStr = ingredientsToUse && ingredientsToUse.length > 0 ? ingredientsToUse.join(", ") : "none specified";
